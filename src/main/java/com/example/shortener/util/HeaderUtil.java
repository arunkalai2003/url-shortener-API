...
public class HeaderUtil {
     ...
     *         or UNKNOWN if {@code userAgent} has no text
     */
     ...
     * {@code null} or blank), and UNKNOWN when the value cannot be parsed
     ...
     *         no text, or UNKNOWN if the host cannot be determined
     */
