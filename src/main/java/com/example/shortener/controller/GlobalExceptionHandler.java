...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> bad(BadRequestException e, HttpServletRequest r) {
        return error(HttpStatus.BAD_REQUEST, "BAD_REQUEST", e.getMessage(), r);
    }

    @ExceptionHandler(ConflictException.class)
    ResponseEntity<ApiError> conflict(ConflictException e, HttpServletRequest r) {
        return error(HttpStatus.CONFLICT, "CONFLICT", e.getMessage(), r);
    }

    @ExceptionHandler(NotFoundException.class)
    ResponseEntity<ApiError> notFound(NotFoundException e, HttpServletRequest r) {
        return error(HttpStatus.NOT_FOUND, "NOT_FOUND", e.getMessage(), r);
    }

    @ExceptionHandler(GoneException.class)
    ResponseEntity<ApiError> gone(GoneException e, HttpServletRequest r) {
        return error(HttpStatus.GONE, "GONE", e.getMessage(), r);
    }

    @ExceptionHandler(ServiceUnavailableException.class)
    ResponseEntity<ApiError> unavailable(ServiceUnavailableException e, HttpServletRequest r) {
        return error(HttpStatus.SERVICE_UNAVAILABLE, "DEPENDENCY_UNAVAILABLE", e.getMessage(), r);
    }
    ...
    private ResponseEntity<ApiError> error(HttpStatus s, String code, String m, HttpServletRequest r) {
        String cid = (String) r.getAttribute("correlationId");
